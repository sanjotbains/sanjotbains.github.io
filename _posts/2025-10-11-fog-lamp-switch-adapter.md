...
In some cases, a kit requires a proprietary switch or, more often, a customer brings to me a kit with a switch included and does not want to pay dealer prices for a new (admittedly pretty good) switch when they have a perfectly working switch right there; I recently purchased a fan override switch for a Volvo for $75.

In today's case, we have a MACK CX13 in for a whole dump truck setup: a wet kit, tarp electrics, tailgate controls, and some lights. For the new fog lamps, the customer provided to me a switch, a generic from an auto parts store, that is too small to fit in the Mack's 22mm x 44 mm hole.

It's a slow weekend so I thought I'd take some time to design and 3D print an adapter.

The geometry on this is pretty tricky so I'll just show you the model out right:
<iframe src="https://gmail3378138.autodesk360.com/shares/public/SH90d2dQT28d5b602811b83dd84dbd3f49c5?mode=embed" width="600" height="600" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"  frameborder="0"></iframe>
...
![First Test Print]({{ site.baseurl }}/assets/img/switch_adapter/test1.jpg)
...
![Second Test Print]({{ site.baseurl }}/assets/img/switch_adapter/test2.jpg)

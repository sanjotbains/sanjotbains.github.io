---
layout: post    
title: "Adapting Switches 2"
subtitle: 
date: 2026-3-18
post_class: 3dprinting
tags: [3d printing, electrical, Onshape]
---

I'll save you the blurb on this one. Trucks need switch adapters.
...
![First Test Print]({{ site.baseurl }}/assets/img/switch_adapter2/test1.jpg)

We can then immediately proceed to creating the clasp geometry.
This adapter's clasp features the same winged geometry as the last one, but I've decided to take a different route to modeling it. 
Instead of an extrusion with features being "cut out" of it, we simply loft the end profiles together into the continuous solid of the wing. 
...
<div style="display: flex;">
  ...
  <img src="{{ site.baseurl }}/assets/img/switch_adapter2/installed2.jpg" style="width: 50%;" />
</div>

## And in its final resting place:

![Installed]({{ site.baseurl }}/assets/img/switch_adapter2/installed3.jpg)

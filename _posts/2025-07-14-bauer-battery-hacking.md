...
<!-- ![Harbor Freight Tool Tiers]({{ site.baseurl }}/assets/img/bauer/tool_tiers.jpg) -->
...
<!-- TODO: Add price tag photo here -->
<!-- ![Price tag on the open-box Bauer cold saw]({{ site.baseurl }}/assets/img/bauer/price-tag.jpg) -->
...
<!-- TODO: Add DeWalt battery innards photo here -->
<!-- ![DeWalt battery internals]({{ site.baseurl }}/assets/img/bauer/dewalt-innards.jpg) -->
...
<!-- TODO: Add adapter internals photo here -->
<!-- ![Amazon adapter PCB internals]({{ site.baseurl }}/assets/img/bauer/adapter-internals.jpg) -->
